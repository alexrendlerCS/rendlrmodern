...
export const projects: Project[] = [
  ...
  },
  {
    ...
    thumbnail: "/placeholders/budgettracker.svg",
  },
  {
...
export const parallaxCards = [
  { label: "RealtyEdge",     tag: "Web Dev",     icon: "RE", link: "https://realtyedge.vercel.app", thumbnail: "/realty-edge-showcase.png" },
  { label: "AIcademy",       tag: "AI / EdTech", icon: "AI", link: "https://aicademy-six.vercel.app/", thumbnail: "/Aicademy.png" },
  { label: "Coach Kilday",   tag: "Full Stack",  icon: "CK", link: "https://www.coachkilday.com", thumbnail: "/fitness_trainer_platform.png" },
  { label: "TrainerDev",     tag: "SaaS",        icon: "TD", link: "https://trainerdev.vercel.app/", thumbnail: "/trainerdev.png" },
  { label: "SEO Insights",   tag: "AI / Data",   icon: "SI", link: "https://github.com/alexrendlerCS/SEO_Insight", thumbnail: "/SEOInsights.png" },
  { label: "Nexus Crypto",   tag: "Finance",     icon: "NX", link: "https://nexus-brokerage.netlify.app/", thumbnail: "/nexus.png" },
  { label: "StatsX",         tag: "Analytics",   icon: "SX", link: "https://www.statsx.online/", thumbnail: "/statsx.png" },
  { label: "Budget Tracker", tag: "Finance",     icon: "BT", link: "https://github.com/alexrendlerCS/BudgetTracker", thumbnail: "/budgettracker.png" },
  { label: "AI Resume",      tag: "NLP",         icon: "AR", link: "https://github.com/alexrendlerCS/AIResume", thumbnail: "/resumebuilder.png" },
  { label: "Bells & Bones",  tag: "E-Commerce",  icon: "BB", link: "https://bandb-one.vercel.app/", thumbnail: "/bellsandbones.png" },
  { label: "CoreVybe",       tag: "Client Work", icon: "CV", link: "https://corevybe.com/", thumbnail: "/CoreVybe.jpg" },
  { label: "Trading Bot",    tag: "ML",          icon: "TB", link: "https://github.com/alexrendlerCS", thumbnail: "/stock_trading_bot.png" },
  { label: "Rendlr.dev",     tag: "Agency",      icon: "R·", link: "https://www.rendlr.dev", thumbnail: "/rendlr.png" },
  { label: "Web Security",   tag: "DevSecOps",   icon: "WS", link: "/", thumbnail: "/datasecurity.png" },
  { label: "AI Certified",   tag: "Engineering", icon: "AC", link: "/", thumbnail: "/AICert.png" },
];
